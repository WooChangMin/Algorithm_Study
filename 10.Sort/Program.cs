namespace _10.Sorting
{
    internal class Program
    {
        ...
        // 순서대로 빼면서 이진트리 만든다고 생각하면 편함 힙생태를 이용하는것
        // 동일한 개체들이 많을경우 순서가 꺠지는 정렬임 (불안정 정렬)
        ...
        // <합병정렬>
        // 데이터를 2분할하여 정렬 후 합병
        // 반분할 반분할을 저장하고 있으므로 메모리적인 부분에서 부족함이생김. 시간복잡도가적은것은 장점.
        ...
        // 최악의 경우 시간 복잡도가 O(n^2)임 -> ex)내림차순인경우
        // 동일한 개체들이 많을경우 순서가 꺠지는 정렬임 (불안정 정렬)
